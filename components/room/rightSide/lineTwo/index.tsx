...
const LineTwo = () => {
    return (
        <>
            <div className='flex flex-row border-[#0B122A] w-full border-2 border-r-0 rounded-tl-lg'>
                ...
                <div className='p-3 border-l-2 min-w-[200px] border-[#0B122A]'>
                    <div className='flex flex-col gap-2'>
                        <h1 className='text-xl font-bold'>KBMDTIF</h1>
                        <div className='flex flex-row w-full justify-between items-center'>
                            <BsFillPeopleFill className="text-[#9AA3B2] text-3xl" />
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" value="" className="sr-only peer items-center" />
                ...
                <div className='p-3 border-l-2 min-w-[200px] border-[#0B122A]'>
                    <div className='flex flex-col gap-2'>
                        <h1 className='text-xl font-bold'>BCC</h1>
                        <div className='flex flex-row w-full justify-between items-center'>
                            <BsFillPeopleFill className="text-[#9AA3B2] text-3xl" />
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" value="" className="sr-only peer items-center" />
